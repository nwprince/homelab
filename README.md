...
[![GitHub Release](https://img.shields.io/github/v/release/nwprince/homelab)](https://github.com/nwprince/homelab/releases)
[![Go Reference](https://pkg.go.dev/badge/github.com/nwprince/homelab.svg)](https://pkg.go.dev/github.com/nwprince/homelab)
[![go.mod](https://img.shields.io/github/go-mod/go-version/nwprince/homelab)](go.mod)
[![Build Status](https://img.shields.io/github/workflow/status/nwprince/homelab/build)](https://github.com/nwprince/homelab/actions?query=workflow%3Abuild+branch%3Amain)
[![Go Report Card](https://goreportcard.com/badge/github.com/nwprince/homelab)](https://goreportcard.com/report/github.com/nwprince/homelab)
[![Codecov](https://codecov.io/gh/nwprince/homelab/branch/main/graph/badge.svg)](https://codecov.io/gh/nwprince/homelab)
...
1. Replace all occurences of `nwprince/homelab` to `your_org/repo_name` in all files.
